...
# Inicialização do Cliente com nome padronizado
client_gemini = genai.Client(api_key=GEMINI_API_KEY)

def renovar_token():
    """Renova o token de 2024 automaticamente."""
...
def executar():
    ...
    # GERAÇÃO COM NOME DE VARIÁVEL CORRIGIDO
    texto_corpo = ""
    try:
        # Tentativa 1: Flash v1
        ...
        print(f"Tentando alternativa Pro após erro no Flash: {e}")
        try:
            # Tentativa 2: Pro v1 (Mais estável para certas chaves)
            response = client_gemini.models.generate_content(
    ...
    try:
        ...
        print(f"✅ SUCESSO! Artigo publicado.")
    except Exception as e:
